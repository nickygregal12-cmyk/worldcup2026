...
const FAQS = [
  ...
  },
  {
    ...
    a: 'A joker doubles your points for that prediction if you get it right. You have 5 jokers for the group stage and 3 for the knockout picks. Use them wisely — if your joker prediction is wrong, you score 0 (same as a normal wrong prediction). Jokers are not returned if wrong.',
  },
  {
