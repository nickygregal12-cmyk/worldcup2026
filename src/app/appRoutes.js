...
export const ADMIN_SECTIONS = Object.freeze([
  ...
  Object.freeze({ key: ADMIN_SECTION.SIMULATOR, label: 'Simulator', hash: '#/admin?section=simulator', heading: 'Tournament simulator' }),
...
export const APP_DESTINATIONS = Object.freeze([
  ...
  Object.freeze({ key: APP_ROUTE.REVIEW, label: 'Review', shortLabel: 'Review', hash: '#/review', icon: 'check' }),
...
export function playerViewParamsFromHash(hashValue = '') {
  ...
  const tab = ['overview', 'predictions', 'bracket', 'tables', 'points', 'headToHead'].includes(requestedTab) ? requestedTab : 'overview'
  return Object.freeze({
