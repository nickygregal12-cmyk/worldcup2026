...
export const GUEST_PREDICTION_STATE_VERSION = 'euro28-guest-state-v2'
export const GUEST_PREDICTION_BUNDLE_FORMAT = 'euro28-guest-prediction-bundle'
export const GUEST_PREDICTION_BUNDLE_VERSION = 2
export const GUEST_REFERENCE_MODEL_VERSION = 'euro28-guest-reference-v2'
...
export const GUEST_MATCH_RANGES = Object.freeze({
  ...
  bracket: Object.freeze({ first: 37, last: 51, count: 15 }),
  total: 51,
})
