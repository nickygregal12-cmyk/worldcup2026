...
5A. STAGE-CORE-PAGE-ADOPTION-1A-GROUPS completed as the Groups slice under STAGE-CORE-PAGE-ADOPTION-1; STAGE-CORE-PAGE-ADOPTION-1A-GROUPS-COPY-REPAIR completed as the initial Groups player-facing copy repair; STAGE-PLAYER-FACING-COPY-SWEEP-2 completed before the next visual adoption slice; STAGE-CORE-PAGE-ADOPTION-1B-ORIGINAL-BRACKET completed as the Original Bracket G slice; STAGE-CORE-PAGE-ADOPTION-1
