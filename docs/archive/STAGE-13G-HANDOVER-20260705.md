...
Post-deploy `npm run verify:foundation-page` passed after `06d5218`. Active migrations remain 21. Migration 019 is applied.
...
- Active migrations remain 21 unless a genuine schema/read-contract gap is proved and explicitly approved.
