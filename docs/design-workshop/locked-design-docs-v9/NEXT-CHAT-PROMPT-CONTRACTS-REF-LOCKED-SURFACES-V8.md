...
Record the v8 pack into the repo before implementation.
...
Record these as locked planning/rules decisions.

Do not implement them during the recording commit.
