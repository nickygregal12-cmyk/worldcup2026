# Next chat prompt — Record locked visual contracts and missing-surface decisions v5
...
Use this v5 pack as the merged source of truth. Do not install any earlier pack separately. The v3 corrections file is already folded in.
...
## v5 corrections that must be applied during recording
...
## Additional locked notes added in v5
...
## v5 addition to record

The attached v5 pack includes `CANDIDATE-TEAM-POOL-BRIEF.md` and the source PDF `sources/Euro 2028 Predictor Brief.pdf`.
