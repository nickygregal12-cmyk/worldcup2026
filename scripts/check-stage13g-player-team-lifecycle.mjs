...
if (!teamModel.includes('KO Predictor data is not included') || !teamModel.includes('KO Predictor points stay out of it')) fail('Team Profile separation copy is missing')
