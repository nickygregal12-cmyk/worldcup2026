...
if (migrations.length !== 8) fail(`Stage 5 must retain eight migrations after the linked corrections, found ${migrations.length}`)
...
console.log('Active migrations: 8; guest server storage remains absent')
