...
if (migrations.length !== 18) fail(`Stage 16A-P4 expects 18 active migrations, found ${migrations.length}`)
const migration019 = migrations.find(name => /019|migration[-_ ]?019/i.test(name))
if (migration019) fail(`Stage 16A-P4 must not create Migration 019: ${migration019}`)
