...
assert(migrations.length === 15, `Stage 14 must preserve 15 migrations; found ${migrations.length}.`)
assert(!migrations.some(file => file.includes('202607020016')), 'Stage 14 must not add Migration 016.')
...
console.log('Database: unchanged at 15 migrations.')
