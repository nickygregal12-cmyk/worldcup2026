...
assert(bundle.includes('The browser-only guest foundation is ready.'), 'The deployed bundle is not the Stage 4 guest foundation application.')
...
console.log('Public branding: Euro 2028 guest foundation')
