...
assert(bundle.includes('The Euro build now has a clean front door.'), 'The deployed bundle is not the isolated Euro foundation application.')
...
console.log('Public branding: Euro 2028 foundation')
